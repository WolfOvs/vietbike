...
function CabinCruiserCharts({ data, stationId, turbochargerId, activeTab, changeOpenModal, isThresholds, thresholds, configurations, labels }) {
...
export default withRouter(
	React.memo(CabinCruiserCharts, (prevProps, nextProps) => isEqualToObject(prevProps, nextProps))
);
