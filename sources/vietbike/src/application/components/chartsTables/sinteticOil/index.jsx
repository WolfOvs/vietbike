...
function SinteticOilChart({data, stationId, turbochargerId, activeTab, changeOpenModal, isThresholds, thresholds, configurations, labels }) {
...
export default withRouter(
	React.memo(SinteticOilChart, (prevProps, nextProps) => isEqualToObject(prevProps, nextProps))
);
